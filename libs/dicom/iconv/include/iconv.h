...
extern LIBICONV_DLL_EXPORTED void iconvlist(
    int (*do_one)(unsigned int namescount, const char* const* names,
                  void* data),
    void* data);
...
/* Sets the original and the current installation prefix of the package.
   ...
   instead of "/").  */
extern LIBICONV_DLL_EXPORTED void libiconv_set_relocation_prefix(
