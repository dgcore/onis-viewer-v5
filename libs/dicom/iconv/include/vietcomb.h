...
#define viet_comp_table0300_len 31
    ...
    {0x01AF, 0x1EEA},
    {0x01B0, 0x1EEB},
#define viet_comp_table0301_idx \
  (viet_comp_table0300_idx + viet_comp_table0300_len)
#define viet_comp_table0301_len 63
    ...
    {0x01AF, 0x1EE8},
    {0x01B0, 0x1EE9},
#define viet_comp_table0303_idx \
  (viet_comp_table0301_idx + viet_comp_table0301_len)
#define viet_comp_table0303_len 34
    ...
    {0x01AF, 0x1EEE},
    {0x01B0, 0x1EEF},
#define viet_comp_table0309_idx \
  (viet_comp_table0303_idx + viet_comp_table0303_len)
#define viet_comp_table0309_len 24
    ...
    {0x01AF, 0x1EEC},
    {0x01B0, 0x1EED},
#define viet_comp_table0323_idx \
  (viet_comp_table0309_idx + viet_comp_table0309_len)
...
static const struct viet_decomp viet_decomp_table[] = {
    ...
    {0x1E47, 0x006E, 4},
    {0x1E4C, 0x00D3, 2},
    /*{ 0x1E4C, 0x00D5, 1 },*/ /*{ 0x1E4C, 0x004F, 1, 2 },*/
    {0x1E4D, 0x00F3, 2},
    /*{ 0x1E4D, 0x00F5, 1 },*/ /*{ 0x1E4D, 0x006F, 1, 2 },*/
    {0x1E4E, 0x00D6, 2},
    {0x1E4F, 0x00F6, 2},
    {0x1E54, 0x0050, 1},
    {0x1E55, 0x0070, 1},
    ...
    {0x1E6D, 0x0074, 4},
    {0x1E78, 0x00DA, 2},
    /*{ 0x1E78, 0x0168, 1 },*/ /*{ 0x1E78, 0x0055, 1, 2 },*/
    {0x1E79, 0x00FA, 2},
    /*{ 0x1E79, 0x0169, 1 },*/ /*{ 0x1E79, 0x0075, 1, 2 },*/
    {0x1E7C, 0x0056, 2},
    {0x1E7D, 0x0076, 2},
    {0x1E7E, 0x0056, 4},
    {0x1E7F, 0x0076, 4},
