...
static int tcvn_mbtowc(conv_t conv, ucs4_t* pwc, const unsigned char* s,
                       size_t n) {
  unsigned char c = *s;
  unsigned short wc;
...
static int tcvn_wctomb(conv_t conv, unsigned char* r, ucs4_t wc, size_t n) {
  unsigned char c = 0;
  ...
  /* Try compatibility or canonical decomposition. */
  {
    ...
    unsigned int i1 = 0;
    unsigned int i2 =
        sizeof(viet_decomp_table) / sizeof(viet_decomp_table[0]) - 1;
