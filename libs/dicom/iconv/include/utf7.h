...
static int utf7_mbtowc(conv_t conv, ucs4_t* pwc, const unsigned char* s,
                       size_t n) {
...
static int utf7_wctomb(conv_t conv, unsigned char* r, ucs4_t iwc, size_t n) {
...
static int utf7_reset(conv_t conv, unsigned char* r, size_t n) {
  state_t state = conv->ostate;
  if (state & 3) {
    /* deactivate base64 encoding */
