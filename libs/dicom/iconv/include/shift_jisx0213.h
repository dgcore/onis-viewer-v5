...
static int shift_jisx0213_mbtowc(conv_t conv, ucs4_t* pwc,
...
#define shift_jisx0213_comp_table02e9_idx \
  (shift_jisx0213_comp_table02e5_idx + shift_jisx0213_comp_table02e5_len)
#define shift_jisx0213_comp_table02e9_len 1
    {0x8680, 0x8686}, /* 0x12B66 = 0x12B60 U+02E9 */
#define shift_jisx0213_comp_table0300_idx \
  (shift_jisx0213_comp_table02e9_idx + shift_jisx0213_comp_table02e9_len)
...
#define shift_jisx0213_comp_table0301_idx \
  (shift_jisx0213_comp_table0300_idx + shift_jisx0213_comp_table0300_len)
...
#define shift_jisx0213_comp_table309a_idx \
  (shift_jisx0213_comp_table0301_idx + shift_jisx0213_comp_table0301_len)
...
static int shift_jisx0213_wctomb(conv_t conv, unsigned char* r, ucs4_t wc,
                                 size_t n) {
  int count = 0;
