 ...
 *                                           0x2501 # BOX DRAWINGS HEAVY
 * HORIZONTAL 0xA2A5  0x255E # BOX DRAWINGS VERTICAL SINGLE AND RIGHT DOUBLE
 *                                           0x251D # BOX DRAWINGS VERTICAL
 * LIGHT AND RIGHT HEAVY 0xA2A6  0x256A # BOX DRAWINGS VERTICAL SINGLE AND
 * HORIZONTAL DOUBLE 0x253F # BOX DRAWINGS VERTICAL LIGHT AND HORIZONTAL HEAVY
 *    0xA2A7  0x2561 # BOX DRAWINGS VERTICAL SINGLE AND LEFT DOUBLE
 *                                           0x2525 # BOX DRAWINGS VERTICAL
 * LIGHT AND LEFT HEAVY 0xA2CC    ---                          0x3038 # HANGZHOU
 * NUMERAL TEN 0xA2CD  0x5344                         0x3039 # HANGZHOU NUMERAL
 * TWENTY 0xA2CE    ---                          0x303A # HANGZHOU NUMERAL
 * THIRTY
 *
 ...
 *    0xC6E7..0xC77A  hiragana (U+3041..U+3093, was in BIG5.TXT at
 * 0xC6A5..0xC6F7) 0xC77B..0xC7F2  katakana (U+30A1..U+30F6, was in BIG5.TXT at
 * 0xC6F8..0xC7B0)
 *
...
static const unsigned short big5_2003_2uni_pagec6[70] = {
    ...
    0x2177, 0x2178, 0x2179, 0x2f02, 0x2f03, 0x2f05, 0x2f07, 0x2f0c, 0x2f0d,
    0x2f0e, 0x2f13, 0x2f16, 0x2f19, 0x2f1b, 0x2f22, 0x2f27, 0x2f2e, 0x2f33,
    0x2f34, 0x2f35, 0x2f39, 0x2f3a, 0x2f41, 0x2f46, 0x2f67, 0x2f68, 0x2fa1,
    0x2faa, 0x00a8, 0xff3e, 0x30fd, 0x30fe, 0x309d, 0x309e, 0xfffd, 0xfffd,
...
static const unsigned short big5_2003_2uni_pagef9[41] = {
    ...
    0x2557,
    0x255a,
    0x255d, /* not invertible */
    0x2593,
};

static int big5_2003_mbtowc(conv_t conv, ucs4_t* pwc, const unsigned char* s,
                            size_t n) {
  unsigned char c = *s;
  /* Code set 0 (ASCII) */
  if (c < 0x80)
      ...
      return RET_TOOFEW(0);
    {
      ...
      if ((c2 >= 0x40 && c2 < 0x7f) || (c2 >= 0xa1 && c2 < 0xff)) {
        if (c >= 0xa1) {
          if (c < 0xa3) {
            unsigned int i =
                157 * (c - 0xa1) + (c2 - (c2 >= 0xa1 ? 0x62 : 0x40));
          ...
          if (!((c == 0xc6 && c2 >= 0xa1) || c == 0xc7)) {
            ...
            unsigned int i =
                157 * (c - 0xc6) + (c2 - (c2 >= 0xa1 ? 0x62 : 0x40));
            if (i < 133) {
              /* 63 <= i < 133. */
...
static const unsigned char big5_2003_2charset_page25[29] = {
    /* 0x2550 */
    0xf9, 0xf8, 0xe6, 0xef, 0xdd, 0xe8, 0xf1, 0xdf, 0xec, 0xf5,
    0xe3, 0xee, 0xf7, 0xe5, 0xe9, 0xf2, 0xe0, 0xeb, 0xf4, 0xe2,
    0xe7, 0xf0, 0xde, 0xed, 0xf6, 0xe4, 0xea, 0xf3, 0xe1,
};

static int big5_2003_wctomb(conv_t conv, unsigned char* r, ucs4_t wc,
                            size_t n) {
  unsigned char buf[2];
  int ret;
