/*
 * Copyright (C) 1999-2001, 2008, 2011-2012, 2016, 2018 Free Software
 * Foundation, Inc. This file is part of the GNU LIBICONV Library.
 *
...
static int iso2022_jpms_mbtowc(conv_t conv, ucs4_t* pwc, const unsigned char* s,
                               size_t n) {
...
static int iso2022_jpms_wctomb(conv_t conv, unsigned char* r, ucs4_t wc,
                               size_t n) {
