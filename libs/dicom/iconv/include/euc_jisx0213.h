...
static int euc_jisx0213_mbtowc(conv_t conv, ucs4_t* pwc, const unsigned char* s,
                               size_t n) {
...
#define euc_jisx0213_comp_table02e9_idx \
  (euc_jisx0213_comp_table02e5_idx + euc_jisx0213_comp_table02e5_len)
#define euc_jisx0213_comp_table02e9_len 1
    {0xabe0, 0xabe6}, /* 0x12B66 = 0x12B60 U+02E9 */
#define euc_jisx0213_comp_table0300_idx \
  (euc_jisx0213_comp_table02e9_idx + euc_jisx0213_comp_table02e9_len)
...
#define euc_jisx0213_comp_table0301_idx \
  (euc_jisx0213_comp_table0300_idx + euc_jisx0213_comp_table0300_len)
...
#define euc_jisx0213_comp_table309a_idx \
  (euc_jisx0213_comp_table0301_idx + euc_jisx0213_comp_table0301_len)
...
static int euc_jisx0213_wctomb(conv_t conv, unsigned char* r, ucs4_t wc,
                               size_t n) {
  int count = 0;
