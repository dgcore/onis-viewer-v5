...
static const unsigned short hkscs2008_2uni_page87[126] = {
    /* 0x87 */
    0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd,
    0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd,
    0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd,
    0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd,
    0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd,
    0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x22fd,
    0x22fd, 0x22fd, 0x22fd, 0x22fd, 0x0175, 0x2453, 0x299e, 0x2d21, 0x03ec,
    0x2bde, 0x02f5, 0x16fc, 0x2197, 0x2a61, 0x300d, 0x26ea, 0x238a, 0x275e,
    0x060a, 0x1884, 0x2196, 0x1f2f, 0x0930, 0x1a13, 0x0d96, 0x204a, 0x1e18,
    0x15d0, 0x1632, 0x0f60, 0x1129, 0x1b9d, 0x144c, 0x17c5, 0x1082, 0x162c,
    0x0a4f, 0x1d46, 0x00e6, 0x13c4, 0x2cb9, 0x14c6, 0x21c7, 0x0cb3, 0x092f,
    0x0b4c, 0x0531, 0x298e, 0x0d18, 0x1672, 0x2f65, 0x1c8f, 0x08ae, 0x2e88,
    0x0581, 0x2c99, 0x17ae, 0x25bc, 0x21c8, 0x25c1, 0x25c9, 0x25cc, 0x21c9,
    0x1904, 0x28bb, 0x04b4, 0x21ca, 0x07e1, 0x31ff, 0x0ec1, 0x126e, 0x21cb,
};
...
static int hkscs2008_mbtowc(conv_t conv, ucs4_t* pwc, const unsigned char* s,
                            size_t n) {
...
static const unsigned short hkscs2008_2charset[68] = {
    0x87be, 0x877a, 0x87a2, 0x877e, 0x87d9, 0x87c6, 0x87ce, 0x87aa, 0x87db,
    0x87cc, 0x87c4, 0x87ae, 0x87bc, 0x87c5, 0x87c3, 0x87c8, 0x87b0, 0x87dd,
    0x87b5, 0x87ba, 0x87b6, 0x87de, 0x87bf, 0x87b8, 0x87c1, 0x87b3, 0x87bb,
    0x87b4, 0x87c9, 0x87a3, 0x87d0, 0x87b9, 0x87ab, 0x87d7, 0x87af, 0x87b7,
    0x87cb, 0x87bd, 0x87b2, 0x87ad, 0x87b1, 0x87ac, 0x87a4, 0x87c2, 0x87d2,
    0x87d6, 0x87da, 0x87df, 0x87a8, 0x877b, 0x87d1, 0x87d3, 0x87d4, 0x87d5,
    0x87a7, 0x87a9, 0x87d8, 0x87c7, 0x877c, 0x87a5, 0x87a1, 0x87cf, 0x87c0,
    0x877d, 0x87cd, 0x87ca, 0x87a6, 0x87dc,
};

static const Summary16 hkscs2008_uni2indx_page34[15] = {
    /* 0x3400 */
    {0, 0x0000}, {0, 0x0000}, {0, 0x0000}, {0, 0x0000}, {0, 0x0000},
    {0, 0x0000}, {0, 0x0000}, {0, 0x0000}, {0, 0x0000}, {0, 0x0000},
    {0, 0x0000}, {0, 0x0000}, {0, 0x0000}, {0, 0x0000}, {0, 0x0040},
};
...
static const Summary16 hkscs2008_uni2indx_page3e[15] = {
    /* 0x3e00 */
    {3, 0x0000}, {3, 0x0000}, {3, 0x0000}, {3, 0x0000}, {3, 0x0000},
    {3, 0x0000}, {3, 0x0000}, {3, 0x0000}, {3, 0x0000}, {3, 0x0000},
    {3, 0x0000}, {3, 0x0000}, {3, 0x0000}, {3, 0x0000}, {3, 0x1000},
};
...
static const Summary16 hkscs2008_uni2indx_page52[5] = {
    /* 0x5200 */
    {12, 0x0000}, {12, 0x0000}, {12, 0x0000}, {12, 0x0000}, {12, 0x8000},
};
static const Summary16 hkscs2008_uni2indx_page54[5] = {
    /* 0x5400 */
    {13, 0x0000}, {13, 0x0000}, {13, 0x0000}, {13, 0x0000}, {13, 0x1000},
};
...
static const Summary16 hkscs2008_uni2indx_page62[13] = {
    /* 0x6200 */
    {17, 0x0000}, {17, 0x0000}, {17, 0x0000}, {17, 0x0000}, {17, 0x0000},
    {17, 0x0000}, {17, 0x0000}, {17, 0x0000}, {17, 0x0000}, {17, 0x0000},
    {17, 0x0000}, {17, 0x0000}, {17, 0x0002},
};
...
static const Summary16 hkscs2008_uni2indx_page88[10] = {
    /* 0x8800 */
    {35, 0x0000}, {35, 0x0000}, {35, 0x0000}, {35, 0x0000}, {35, 0x0000},
    {35, 0x0000}, {35, 0x0000}, {35, 0x0000}, {35, 0x0000}, {35, 0x2000},
};
static const Summary16 hkscs2008_uni2indx_page8b[9] = {
    /* 0x8b00 */
    {36, 0x0000}, {36, 0x0000}, {36, 0x0000}, {36, 0x0000}, {36, 0x0000},
    {36, 0x0000}, {36, 0x0000}, {36, 0x0000}, {36, 0x8000},
};
static const Summary16 hkscs2008_uni2indx_page90[5] = {
    /* 0x9000 */
    {37, 0x0000}, {37, 0x0000}, {37, 0x0000}, {37, 0x0000}, {37, 0x0040},
};
...
static const Summary16 hkscs2008_uni2indx_page97[5] = {
    /* 0x9700 */
    {40, 0x0000}, {40, 0x0000}, {40, 0x0000}, {40, 0x0000}, {40, 0x0400},
};
static const Summary16 hkscs2008_uni2indx_page9f[13] = {
    /* 0x9f00 */
    {41, 0x0000}, {41, 0x0000}, {41, 0x0000}, {41, 0x0000}, {41, 0x0000},
    {41, 0x0000}, {41, 0x0000}, {41, 0x0000}, {41, 0x0000}, {41, 0x00c0},
    {43, 0x0000}, {43, 0x0000}, {43, 0x0f80},
};
static const Summary16 hkscs2008_uni2indx_page20a[9] = {
    /* 0x20a00 */
    {48, 0x0000}, {48, 0x0000}, {48, 0x0000}, {48, 0x0000}, {48, 0x0000},
    {48, 0x0000}, {48, 0x0000}, {48, 0x0000}, {48, 0x0400},
};
static const Summary16 hkscs2008_uni2indx_page21d[6] = {
    /* 0x21d00 */
    {49, 0x0000}, {49, 0x0000}, {49, 0x0000},
    {49, 0x0000}, {49, 0x0000}, {49, 0x0008},
};
static const Summary16 hkscs2008_uni2indx_page224[13] = {
    /* 0x22400 */
    {50, 0x0000}, {50, 0x0000}, {50, 0x0000}, {50, 0x0000}, {50, 0x0000},
    {50, 0x0000}, {50, 0x0000}, {50, 0x0000}, {50, 0x0000}, {50, 0x0000},
    {50, 0x0000}, {50, 0x1000}, {51, 0x1202},
};
...
static const Summary16 hkscs2008_uni2indx_page258[14] = {
    /* 0x25800 */
    {60, 0x0000}, {60, 0x0000}, {60, 0x0000}, {60, 0x0000}, {60, 0x0000},
    {60, 0x0000}, {60, 0x0000}, {60, 0x0000}, {60, 0x0000}, {60, 0x0000},
    {60, 0x0000}, {60, 0x0000}, {60, 0x0000}, {60, 0x4000},
};
...
static const Summary16 hkscs2008_uni2indx_page26e[9] = {
    /* 0x26e00 */
    {64, 0x0000}, {64, 0x0000}, {64, 0x0000}, {64, 0x0000}, {64, 0x0000},
    {64, 0x0000}, {64, 0x0000}, {64, 0x0000}, {64, 0x0100},
};
...
static int hkscs2008_wctomb(conv_t conv, unsigned char* r, ucs4_t wc,
                            size_t n) {
  if (n >= 2) {
