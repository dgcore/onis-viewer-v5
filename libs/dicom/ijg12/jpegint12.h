...
struct jpeg_c_codec {
  JMETHOD(void, entropy_start_pass,
...
EXTERN(void)
jinit_c_diff_controller JPP((j_compress_ptr cinfo, boolean need_full_buffer));
...
EXTERN(void)
jinit_d_diff_controller JPP((j_decompress_ptr cinfo, boolean need_full_buffer));
