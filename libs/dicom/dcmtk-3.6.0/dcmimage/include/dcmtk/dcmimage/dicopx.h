...
public:
   ...
   */
  DiColorPixel(const DiDocument* docu, const DiInputPixel* pixel,
   ...
   */
  virtual OFBool getPixelData(void* data, const unsigned long count,
   ...
   ** @return number of bytes allocated by the bitmap, or 0 if an error occured
   */
  virtual unsigned long createAWTBitmap(void*& data, const Uint16 width,
                                        const Uint16 height,
...
protected:
  ...
  /// planar configuration of the original pixel data (0 = color-by-pixel, 1 =
  /// color-by-plane)
