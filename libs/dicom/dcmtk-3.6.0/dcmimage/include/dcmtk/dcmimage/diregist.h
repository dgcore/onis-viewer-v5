...
/** Class to color support to dcmimgle library
 */
...
public:
   ...
   */
  virtual DiImage* createImage(const DiDocument* docu, const EI_Status status,
...
static DiRegister Init_dcmimage_Module;  // registration pointer is initialized
