...
public:
   ...
   *  @param writeAsOW if true, the LUT Data attributes are encoded as OW
   * instead US.  LUT Data is always written as OW if numberOfColors is 65536.
   *  @param write16BitEntries if true, LUT data is encoded with 16 bits per
   * entry
