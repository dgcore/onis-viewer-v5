 ...
 */
template <class T>
class DiColorScaleTemplate : public DiColorPixelTemplate<T>,
...
public:
   ...
   */
  DiColorScaleTemplate(const DiColorPixel* pixel, const Uint16 columns,
