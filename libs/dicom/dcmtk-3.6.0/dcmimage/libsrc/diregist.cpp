...
DiImage* DiRegister::createImage(const DiDocument* docu, const EI_Status status,
    ...
    if (color != NULL) {
      ...
      if (modality != NULL) {
        switch (color->getRepresentation()) {
          case EPR_Uint8:
            inter = new DiColorMonoTemplate<Uint8>(color, modality, red, green,
                                                   blue);
            break;
          case EPR_Sint8:
            inter = new DiColorMonoTemplate<Sint8>(color, modality, red, green,
                                                   blue);
            break;
          case EPR_Uint16:
            inter = new DiColorMonoTemplate<Uint16>(color, modality, red, green,
                                                    blue);
            break;
          case EPR_Sint16:
            inter = new DiColorMonoTemplate<Sint16>(color, modality, red, green,
                                                    blue);
            break;
          case EPR_Uint32:
            inter = new DiColorMonoTemplate<Uint32>(color, modality, red, green,
                                                    blue);
            break;
          case EPR_Sint32:
            inter = new DiColorMonoTemplate<Sint32>(color, modality, red, green,
                                                    blue);
            break;
        }
      }
