...
public:
   ...
   */
  DcmQueryRetrieveMoveContext(DcmQueryRetrieveDatabaseHandle& handle,
                              const DcmQueryRetrieveOptions& options,
                              const DcmQueryRetrieveConfig* cfg,
                              DIC_US priorstatus, T_ASC_Association* assoc,
                              DIC_US msgid, T_DIMSE_Priority pr)
      : dbHandle(handle),
        options_(options),
...
private:
  ...
  OFBool mapMoveDestination(const char* origPeer, const char* origAE,
