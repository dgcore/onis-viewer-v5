...
public:
   ...
   * upon failure.
   */
  virtual OFCondition makeNewStoreFileName(const char* SOPClassUID,
   ...
   *  @return EC_Normal upon normal completion, or some other OFCondition code
   upon failure.
   */
  virtual OFCondition storeRequest(const char* SOPClassUID,
                                   const char* SOPInstanceUID,
   ...
   * upon failure.
   */
  virtual OFCondition cancelFindRequest(
      DcmQueryRetrieveDatabaseStatus* status) = 0;
   ...
   * upon failure.
   */
  virtual OFCondition cancelMoveRequest(
      DcmQueryRetrieveDatabaseStatus* status) = 0;
