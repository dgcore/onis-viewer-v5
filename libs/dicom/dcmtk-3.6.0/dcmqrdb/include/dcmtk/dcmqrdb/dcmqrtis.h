...
public:
   ...
   */
  void createConfigEntries(const char* configFileName, int remoteDBTitlesCount,
...
private:
  ...
  OFBool TI_remoteFindQuery(TI_DBEntry* db, DcmDataset* query,
  ...
  OFBool TI_buildRemoteImages(TI_DBEntry* db, TI_StudyEntry* study,
                              TI_SeriesEntry* series);
  OFBool TI_buildImages(TI_DBEntry* db, TI_StudyEntry* study,
                        TI_SeriesEntry* series);
  ...
  OFBool findDBPeerTitles(const char* configFileName, TI_DBEntry* dbEntry,
                          const char* peer);
