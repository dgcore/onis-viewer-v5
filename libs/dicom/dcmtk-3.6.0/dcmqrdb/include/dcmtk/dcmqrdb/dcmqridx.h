...
#define DESCRIPTION_MAX_LENGTH \
  128 /* Not related to any particular DICOM attribute */
...
/** this class provides a primitive interface for handling a list of flat DICOM
 * elements, similar to DcmItem, but only for use within the database module
 */
...
struct StudyDescRecord {
  ...
  /// timestamp for last update of this study. Format: output of time(2)
  /// converted to double.
