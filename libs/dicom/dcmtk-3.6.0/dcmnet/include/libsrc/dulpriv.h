...
OFCondition constructAssociatePDU(DUL_ASSOCIATESERVICEPARAMETERS* items,
...
OFCondition constructDataPDU(void* buf, unsigned long length, DUL_DATAPDV type,
                             DUL_PRESENTATIONCONTEXTID ctxID, OFBool last,
                             DUL_DATAPDU* pdu);
...
OFCondition streamDataPDUHead(DUL_DATAPDU* pdu, unsigned char* buf,
                              unsigned long maxLength, unsigned long* rtnLen);
OFCondition parseAssociate(unsigned char* buf, unsigned long len,
