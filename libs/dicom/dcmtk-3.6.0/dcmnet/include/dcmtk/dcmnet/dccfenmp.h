...
public:
   ...
   */
  DcmExtendedNegotiationItem(const DcmUIDHandler& abstractSyntax,
...
public:
   ...
   */
  OFCondition checkConsistency(const char* key,
   ...
   */
  const DcmExtendedNegotiationList* getExtendedNegotiationList(
