...
public:
   ...
   *  @deprecated Please use the other dumpConnectionParameters() function
   * instead!
   */
   ...
   *  first.
   *  @param connections list of transport connections. May contain NULL
   * entries. Upon successful return of this method, all transport connections
   * which are not ready for reading are set to NULL in this array.
   ...
   */
  static OFBool selectReadableAssociation(DcmTransportConnection* connections[],
                                          int connCount, int timeout);
...
private:
   ...
   *    this method, OFFalse if no connection is ready for reading.
   */
  static OFBool safeSelectReadableAssociation(
   ...
   *    this method, OFFalse if no connection is ready for reading.
   */
  static OFBool fastSelectReadableAssociation(
      DcmTransportConnection* connections[], int connCount, int timeout);
