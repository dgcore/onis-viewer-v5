...
public:
  /** constructor
   *  @param presentationContextGroup symbolic identifier of the presentation
   * context list
   *  @param roleSelectionGroup symbolic identifier of the role selection list,
   * may be empty
   *  @param extendedNegotiationGroup symbolic identifier of the extended
   * negotiation list, may be empty
   */
  DcmProfileEntry(const OFString& presentationContextGroup,
...
public:
   ...
   *  @param presentationContextKey symbolic identifier of the presentation
   * context list, must not be NULL
   *  @param roleSelectionKey symbolic identifier of the role selection list,
   * may be NULL
   *  @param extendedNegotiationKey symbolic identifier of the extended
   * negotiation list, may be NULL
   *  @return EC_Normal if successful, an error code otherwise
   */
  OFCondition add(const char* key, const char* presentationContextKey,
