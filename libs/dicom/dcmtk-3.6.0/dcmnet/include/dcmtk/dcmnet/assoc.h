...
enum T_ASC_P_ResultReason { /* Part 8, pp 45. */
                            ASC_P_ACCEPTANCE = 0,
...
enum T_ASC_RejectParametersReason { /* the following values are coded by DUL */
                                    ...
                                    ASC_REASON_SP_ACSE_PROTOCOLVERSIONNOTSUPPORTED =
                                        0x0202,
                                    /* Service Provider Presentation Related
                                       reasons */
                                    ASC_REASON_SP_PRES_TEMPORARYCONGESTION =
                                        0x0301,
                                    ASC_REASON_SP_PRES_LOCALLIMITEXCEEDED =
                                        0x0302
};
 ...
 *  @param network T_ASC_Network will be allocated and returned in this
 * parameter
...
OFString& ASC_printRejectParameters(OFString& str, T_ASC_RejectParameters* rej);
...
OFCondition ASC_acceptContextsWithPreferredTransferSyntaxes(
    ...
    int transferSyntaxCount, T_ASC_SC_ROLE acceptedRole = ASC_SC_ROLE_DEFAULT);

OFCondition ASC_acceptContextsWithTransferSyntax(
    T_ASC_Parameters* params, const char* transferSyntax,
 ...
 *  @param params - [in/out] The association parameters to be filled
 *  @param response  - [in]  The response to return (Kerberos or SAML) (will be
 * copied)
 ...
 *  @return none
 */
void ASC_getCopyOfIdentResponse(T_ASC_Parameters* params, void*& buffer,
...
enum ASC_associateType { ASC_ASSOC_RQ, ASC_ASSOC_AC, ASC_ASSOC_RJ };

OFString& ASC_dumpParameters(OFString& str, T_ASC_Parameters* param,
...
OFCondition ASC_requestAssociation(
    T_ASC_Network* network, T_ASC_Parameters* params, /* params will be saved
                                                       * in the association
                                                       * structure */
    T_ASC_Association** association, void** associatePDU = NULL,
    unsigned long* associatePDUlength = NULL);

OFCondition ASC_receiveAssociation(
    T_ASC_Network* network, T_ASC_Association** association,
    long maxReceivePDUSize, void** associatePDU = NULL,
    unsigned long* associatePDUlength = NULL, OFBool useSecureLayer = OFFalse,
    DUL_BLOCKOPTIONS block = DUL_BLOCK, int timeout = 0);

OFCondition ASC_acknowledgeAssociation(
    T_ASC_Association* assoc, void** associatePDU = NULL,
    unsigned long* associatePDUlength = NULL);
...
/// @deprecated Please use OFString& ASC_printRejectParameters(OFString&,
/// T_ASC_RejectParameters*) instead.
...
/**
 * @deprecated Please use OFString& ASC_dumpParameters(OFString&,
 * T_ASC_Parameters *, ASC_associateType) instead.
 */
void ASC_dumpParameters(T_ASC_Parameters* params,
                        STD_NAMESPACE ostream& outstream);

/// @deprecated You should dump the complete T_ASC_Parameters with
/// ASC_dumpParameters() instead.
