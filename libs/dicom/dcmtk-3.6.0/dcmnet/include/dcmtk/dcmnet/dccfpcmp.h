...
public:
   ...
   */
  DcmPresentationContextItem(const DcmUIDHandler& abstractSyntax,
...
public:
   ...
   *  @param transferSyntaxKey symbolic name of transfer syntax UID list, not
   * checked here.
   *  @return EC_Normal if successful, an error code otherwise
   */
  OFCondition add(const char* key, const char* abstractSyntaxUID,
   ...
   */
  OFBool isKnownAbstractSyntax(const char* key,
   ...
   */
  const DcmPresentationContextList* getPresentationContextList(
