...
public:
  ...
  /** this method prepares a T_ASC_Parameters structure according to the
   * settings of a profile maintained by this object. It is used by an
   * association initiator.
   *  @param symbolic profile name, must not be NULL
   *  @param params T_ASC_Parameters structure to be filled
   *  @return EC_Normal if successful, an error code otherwise
   */
  OFCondition setAssociationParameters(const char* profile,
                                       T_ASC_Parameters& params) const;

  /** this method evaluates an incoming association request according to the
   * settings of a profile maintained by this object. It is used by an
   ...
   *  @return EC_Normal if successful, an error code otherwise
   */
  OFCondition evaluateAssociationParameters(const char* profile,
   ...
   *  @return EC_Normal if successful, an error code otherwise
   */
  OFCondition addPresentationContext(const char* key,
   ...
   *  @return EC_Normal if successful, an error code otherwise
   */
  OFCondition addRole(const char* key, const char* abstractSyntaxUID,
                      T_ASC_SC_ROLE role);
   ...
   *  @return EC_Normal if successful, an error code otherwise
   */
  OFCondition addExtendedNegotiation(const char* key,
                                     const char* abstractSyntaxUID,
   ...
   *  @param presentationContextKey presentation context list key, must not be
   * NULL
   ...
   *  @return EC_Normal if successful, an error code otherwise
   */
  OFCondition addProfile(const char* key, const char* presentationContextKey,
...
private:
  ...
  DcmAssociationConfiguration& operator=(
