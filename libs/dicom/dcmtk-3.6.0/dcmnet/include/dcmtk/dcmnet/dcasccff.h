...
public:
   ...
   */
  static OFCondition initialize(DcmAssociationConfiguration& cfg,
                                const char* filename);
...
private:
   ...
   *  @return EC_Normal if successful, an error code otherwise
   */
  static OFCondition parseTransferSyntaxes(DcmAssociationConfiguration& cfg,
                                           OFConfigFile& config);
   ...
   *  @return EC_Normal if successful, an error code otherwise
   */
  static OFCondition parsePresentationContexts(DcmAssociationConfiguration& cfg,
                                               OFConfigFile& config);
   ...
   *  @return EC_Normal if successful, an error code otherwise
   */
  static OFCondition parseRoleSelectionItems(DcmAssociationConfiguration& cfg,
                                             OFConfigFile& config);
   ...
   *  @return EC_Normal if successful, an error code otherwise
   */
  static OFCondition parseProfiles(DcmAssociationConfiguration& cfg,
                                   OFConfigFile& config);
};
