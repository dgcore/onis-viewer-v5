...
public:
   ...
   */
  DiMono2Image(const DiColorImage* image, const double red, const double green,
               const double blue);
   ...
   */
  DiMono2Image(const DiMonoImage* image, DiMonoOutputPixel* pixel,
   ...
   *  @param  planar  flags, whether the output data (for multi-planar images)
  ...
  DiImage* createScale(const signed long left_pos, const signed long top_pos,
                       ...
                       const unsigned long scale_height, const int interpolate,
   ...
   *  Since the image is already monochrome the effect is the same as with
   *createImage().
   *
   ...
   ** @return pointer to new DiImage object (NULL if an error occurred)
   */
  DiImage* createMono(const double dummy1, const double dummy2,
...
protected:
   ...
   *  @param  fcount  number of frames
   */
  DiMono2Image(const DiMonoImage* image, const unsigned long fstart,
   ...
   *(0..65535)
   */
  DiMono2Image(const DiMonoImage* image, const signed long left_pos,
               ...
               const int aspect = 0, const Uint16 pvalue = 0);
