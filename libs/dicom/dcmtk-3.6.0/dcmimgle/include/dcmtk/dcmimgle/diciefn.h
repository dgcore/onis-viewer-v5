 ...
 */
class DiCIELABFunction : public DiDisplayFunction {
public:
   ...
   *interpolation)
   */
  DiCIELABFunction(const double* val_tab, const unsigned long count,
   ...
   *interpolation)
   */
  DiCIELABFunction(const Uint16* ddl_tab, const double* val_tab,
   ...
   *interpolation)
   */
  DiCIELABFunction(const double val_min, const double val_max,
