...
/** Abstract base class to convert DICOM pixel stream to intermediate
 * representation
 */
class DiInputPixel {
public:
   ...
   */
  DiInputPixel(const unsigned int bits, const unsigned long first,
               const unsigned long number, const unsigned long fsize);
   ...
   *  Determine which integer type (size and signed/unsigned) is necessary to
