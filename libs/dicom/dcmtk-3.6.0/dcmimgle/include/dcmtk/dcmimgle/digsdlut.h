 ...
 */
class DiGSDFLUT : public DiDisplayLUT {
public:
  /** constructor
   *
   ...
   */
  DiGSDFLUT(const unsigned long count, const Uint16 max, const Uint16* ddl_tab,
            const double* val_tab, const unsigned long ddl_cnt,
            const double* gsdf_tab, const double* gsdf_spl,
            const unsigned int gsdf_cnt, const double jnd_min,
            const double jnd_max, const double lum_min, const double lum_max,
            const double amb, const double illum,
...
protected:
   ...
   */
  int createLUT(const Uint16* ddl_tab, const double* val_tab,
