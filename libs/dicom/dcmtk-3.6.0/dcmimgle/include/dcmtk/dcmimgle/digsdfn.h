 ...
 */
class DiGSDFunction : public DiDisplayFunction {
public:
   ...
   *interpolation)
   */
  DiGSDFunction(const double* val_tab, const unsigned long count,
   ...
   *interpolation)
   */
  DiGSDFunction(const Uint16* ddl_tab, const double* val_tab,
   ...
   *interpolation)
   */
  DiGSDFunction(const double val_min, const double val_max,
...
private:
  ...
  /// costant defining the number JND indexes for the maximum luminance/OD range
  /// (1023)
