 ...
 */
template <class T>
class DiMonoRotateTemplate : public DiMonoPixelTemplate<T>,
...
public:
   ...
   */
  DiMonoRotateTemplate(const DiMonoPixel* pixel, const Uint16 src_cols,
      ...
      : DiMonoPixelTemplate<T>(
        ...
        DiRotateTemplate<T>(1, src_cols, src_rows, dest_cols, dest_rows,
                            frames) {
