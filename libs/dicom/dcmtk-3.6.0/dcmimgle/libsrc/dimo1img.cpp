...
DiMono1Image::DiMono1Image(const DiMonoImage* image, const unsigned long fstart,
                           const unsigned long fcount)
    : DiMonoImage(image, fstart, fcount) {}

DiMono1Image::DiMono1Image(const DiMonoImage* image, const signed long left_pos,
...
DiMono1Image::DiMono1Image(const DiMonoImage* image, const int horz,
                           const int vert)
    : DiMonoImage(image, horz, vert) {}

DiMono1Image::DiMono1Image(const DiMonoImage* image, const int degree)
...
int DiMono1Image::getOutputData(void* buffer, const unsigned long size,
...
DiImage* DiMono1Image::createScale(
  ...
  DiImage* image = new DiMono1Image(
...
DiImage* DiMono1Image::createFlip(const int horz, const int vert) const {
...
DiImage* DiMono1Image::createMono(const double, const double,
                                  const double) const {
