...
DiMono2Image::DiMono2Image(const DiMonoImage* image, const unsigned long fstart,
                           const unsigned long fcount)
    : DiMonoImage(image, fstart, fcount) {}

DiMono2Image::DiMono2Image(const DiColorImage* image, const double red,
                           const double green, const double blue)
    : DiMonoImage(image, red, green, blue) {}

DiMono2Image::DiMono2Image(const DiMonoImage* image, const signed long left_pos,
    ...
    : DiMonoImage(image, left_pos, top_pos, src_cols, src_rows, dest_cols,
                  dest_rows, interpolate, aspect, pvalue) {}

DiMono2Image::DiMono2Image(const DiMonoImage* image, const int horz,
                           const int vert)
    : DiMonoImage(image, horz, vert) {}

DiMono2Image::DiMono2Image(const DiMonoImage* image, const int degree)
    : DiMonoImage(image, degree) {}

DiMono2Image::DiMono2Image(const DiMonoImage* image, DiMonoOutputPixel* pixel,
...
int DiMono2Image::getOutputData(void* buffer, const unsigned long size,
...
DiImage* DiMono2Image::createScale(
  ...
  DiImage* image = new DiMono2Image(
...
DiImage* DiMono2Image::createFlip(const int horz, const int vert) const {
...
DiImage* DiMono2Image::createMono(const double, const double,
                                  const double) const {
