...
DVPSGraphicObject_PList::DVPSGraphicObject_PList() : list_() {}

DVPSGraphicObject_PList::DVPSGraphicObject_PList(
    const DVPSGraphicObject_PList& arg)
    : list_() {
...
OFCondition DVPSGraphicObject_PList::read(DcmItem& dset) {
  ...
  if (EC_Normal ==
      dset.search(DCM_GraphicObjectSequence, stack, ESM_fromHere, OFFalse)) {
