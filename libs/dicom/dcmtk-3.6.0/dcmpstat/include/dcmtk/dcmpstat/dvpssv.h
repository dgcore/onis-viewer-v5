...
public:
  ...
  DVPSSoftcopyVOI* clone() {
    return new DVPSSoftcopyVOI(*this);
  }
   ...
   * afterwards.
   *  @param dset the item of the SoftcopyVOILUTSequence from which the data is
   * to be read
   *  @return EC_Normal if successful, an error code otherwise.
   */
  OFCondition read(DcmItem& dset);

  /** writes the dsoftcopy VOI LUT item managed by this object to a DICOM
   * dataset. Copies of the DICOM elements managed by this object are inserted
   * into the DICOM dataset.
   *  @param dset the the item of the SoftcopyVOILUTSequence to which the data
   * is written
   *  @return EC_Normal if successful, an error code otherwise.
   */
   ...
   * handled by the called (e.g. by deleting the displayed area selection
   * object).
   ...
   *  @return EC_Normal upon success, an error code otherwise.
   */
  OFCondition setVOIWindow(double wCenter, double wWidth,
   ...
   *  @return EC_Normal if successful, an error code otherwise.
   */
  OFCondition setVOILUT(DcmUnsignedShort& lutDescriptor,
