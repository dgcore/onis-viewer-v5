...
/** the list of VOI Windows contained in an image attached to a presentation
 * state. This class manages the data structures comprising the VOI Windows of
 * one image attached to a presentation state.
 */
...
public:
  ...
  DVPSVOIWindow_PList* clone() {
    return new DVPSVOIWindow_PList(*this);
  }
