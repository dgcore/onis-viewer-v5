...
/** the representation of a Print Management SCP. This class implements most of
 * the DIMSE behaviour of a DICOM Print SCP and uses Stored Print and Hardcopy
 * Grayscale objects to store received print jobs in the local database.
 */
class DVPSPrintSCP {
public:
  /** constructor
...
private:
   ...
   */
  OFCondition handleNGet(T_DIMSE_Message& rq,
   ...
   *  @return DIMSE_NORMAL if successful, an error code otherwise
   */
  OFCondition handleNSet(T_DIMSE_Message& rq,
                         T_ASC_PresentationContextID presID);
   ...
   *  @return DIMSE_NORMAL if successful, an error code otherwise
   */
  OFCondition handleNAction(T_DIMSE_Message& rq,
                            T_ASC_PresentationContextID presID);
   ...
   *  @return DIMSE_NORMAL if successful, an error code otherwise
   */
  OFCondition handleNCreate(T_DIMSE_Message& rq,
                            T_ASC_PresentationContextID presID);
   ...
   *  @return DIMSE_NORMAL if successful, an error code otherwise
   */
  OFCondition handleNDelete(T_DIMSE_Message& rq,
                            T_ASC_PresentationContextID presID);
   ...
   *  @return DIMSE_NORMAL if successful, an error code otherwise
   */
  OFCondition handleCEcho(T_DIMSE_Message& rq,
                          T_ASC_PresentationContextID presID);
   ...
   *  @param rspDataset response dataset passed back in this parameter (if any)
   */
  void filmSessionNSet(T_DIMSE_Message& rq, DcmDataset* rqDataset,
   ...
   *  @param rspDataset response dataset passed back in this parameter (if any)
   */
  void filmBoxNSet(T_DIMSE_Message& rq, DcmDataset* rqDataset,
                   T_DIMSE_Message& rsp, DcmDataset*& rspDataset);

  /** implements the N-SET operation for the Basic Grayscale Image Box SOP
   * Class.
   *  @param rq request message
   *  @param rqDataset request dataset, may be NULL
   *  @param rsp response message, already initialized
   *  @param rspDataset response dataset passed back in this parameter (if any)
   */
  void imageBoxNSet(T_DIMSE_Message& rq, DcmDataset* rqDataset,
                    T_DIMSE_Message& rsp, DcmDataset*& rspDataset);
   ...
   *  @param rspDataset response dataset passed back in this parameter (if any)
   */
  void filmSessionNCreate(DcmDataset* rqDataset, T_DIMSE_Message& rsp,
                          DcmDataset*& rspDataset);
   ...
   *  @param rspDataset response dataset passed back in this parameter (if any)
   */
  void filmBoxNCreate(DcmDataset* rqDataset, T_DIMSE_Message& rsp,
                      DcmDataset*& rspDataset);
   ...
   *  @param rspDataset response dataset passed back in this parameter (if any)
   */
  void presentationLUTNCreate(DcmDataset* rqDataset, T_DIMSE_Message& rsp,
                              DcmDataset*& rspDataset);
