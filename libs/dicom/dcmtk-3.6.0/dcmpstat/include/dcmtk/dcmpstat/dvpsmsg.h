...
public:
   ...
   *  @param str zero terminated string, may be NULL (in which case an empty
   * string is added)
   */
  ...
  static const Uint32
      clientQRSCP;  // client is Query/Retrieve (Find/Move/Get) SCP
...
public:
  /** constructor
   *  @param clientType type of client application, see constants defined in
   * DVPSIPCMessage
   ...
   */
  DVPSIPCClient(Uint32 clientType, const char* txt, int thePort,
                OFBool keepOpen);
