...
/** the list of text objects contained in a presentation state (internal use
 * only). This class manages the data structures comprising one complete Text
...
public:
  ...
  DVPSTextObject_PList* clone() {
    return new DVPSTextObject_PList(*this);
  }
