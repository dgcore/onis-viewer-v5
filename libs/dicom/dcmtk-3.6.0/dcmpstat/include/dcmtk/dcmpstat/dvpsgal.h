...
/** the list of graphic annotations contained in a presentation state (internal
...
public:
  ...
  DVPSGraphicAnnotation_PList* clone() {
    return new DVPSGraphicAnnotation_PList(*this);
  }
   ...
   * afterwards.
   *  @param dset the dataset from which the GraphicAnnotationSequence is to be
   * read
   *  @return EC_Normal if successful, an error code otherwise.
   */
  OFCondition read(DcmItem& dset);

  /** writes the list of graphic annotations managed by this object to a DICOM
   ...
   */
  size_t getNumberOfTextObjects(const char* layer, const char* instanceUID,
                                unsigned long frame);
   ...
   */
  DVPSTextObject* getTextObject(const char* layer, const char* instanceUID,
                                unsigned long frame, size_t idx);
   ...
   *    upon destruction of the annotation or if this method fails (returns
   * NULL).
   *  @return a pointer to the new text object
   */
  DVPSTextObject* addTextObject(const char* layer, const char* sopclassUID,
                                const char* instanceUID, unsigned long frame,
                                DVPSObjectApplicability applicability,
                                DVPSTextObject* text = NULL);

  /** deletes the text object (applicable to the current image and frame) with
   * the given index on the given layer.
   *  @param layer name of the graphic layer
   *  @param instanceUID SOP instance UID of the current image
   *  @param frame number of the current frame
   *  @param idx index of the text object, must be <
   ...
   */
  OFCondition removeTextObject(const char* layer, const char* instanceUID,
                               unsigned long frame, size_t idx);

  /** moves the text object (applicable to the current image and frame) with the
   * given index on the given layer to a different layer.
   ...
   *  @param new_layer name of the graphic layer to which the text object is
   * moved
   *  @return EC_Normal upon success, an error code otherwise
   */
  OFCondition moveTextObject(const char* old_layer, const char* sopclassUID,
                             const char* instanceUID, unsigned long frame,
   ...
   */
  size_t getNumberOfGraphicObjects(const char* layer, const char* instanceUID,
                                   unsigned long frame);
   ...
   */
  DVPSGraphicObject* getGraphicObject(const char* layer,
                                      const char* instanceUID,
                                      unsigned long frame, size_t idx);

  /** creates a new graphic object on the given layer.
   *  Returns a pointer to the new graphic object. If the graphic layer
   *  does not exist or if the creation of the graphic object fails, NULL is
   * returned.
   *  @param layer name of the graphic layer
   *  @param sopclassUID SOP class UID of the current image
   *  @param instanceUID SOP instance UID of the current image
   *  @param frame number of the current frame
   *  @param applicability applicability of the new text object
   *  @param graphic the graphic object to be inserted. If NULL, a new graphic
   * object is created. If a pointer to an object is passed in this parameter,
   *    it gets owned by this graphic annotation object and will be deleted
   *    upon destruction of the annotation or if this method fails (returns
   * NULL).
   *  @return a pointer to the new graphic object
   */
  DVPSGraphicObject* addGraphicObject(const char* layer,
   ...
   *  @return EC_Normal upon success, an error code otherwise
   */
  OFCondition removeGraphicObject(const char* layer, const char* instanceUID,
                                  unsigned long frame, size_t idx);
   ...
   *  @param new_layer name of the graphic layer to which the graphic object is
   * moved
   *  @return EC_Normal upon success, an error code otherwise
   */
  OFCondition moveGraphicObject(const char* old_layer, const char* sopclassUID,
                                const char* instanceUID, unsigned long frame,
                                size_t idx,
                                DVPSObjectApplicability applicability,
                                const char* new_layer);
