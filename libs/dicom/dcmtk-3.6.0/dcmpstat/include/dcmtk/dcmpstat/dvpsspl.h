...
public:
  ...
  DVPSStoredPrint_PList* clone() {
    return new DVPSStoredPrint_PList(*this);
  }
   ...
   *    has been negotiated at association negotiation
   */
  void printSCPBasicGrayscaleImageBoxSet(DVInterface& cfg, const char* cfgname,
                                         T_DIMSE_Message& rq,
   ...
   *  with all image boxes in all film boxes on a Print SCP that requires a
