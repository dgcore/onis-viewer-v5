 ...
 */
class DSRWaveformTreeNode : public DSRDocumentTreeNode,
...
public:
   ...
   *  The method isShort() from the base class DSRWaveformReferenceValue is
   *called.
  ...
  /** print content item.
   *  A typical output looks like this: has properties
   *WAVEFORM:=(HemodynamicWaveform Storage,"1.2.3")
