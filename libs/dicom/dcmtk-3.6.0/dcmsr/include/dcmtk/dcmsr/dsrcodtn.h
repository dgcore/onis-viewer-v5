 ...
 */
class DSRCodeTreeNode : public DSRDocumentTreeNode, public DSRCodedEntryValue {
public:
  /** constructor
  ...
  /** print content item.
   *  A typical output looks like this: has concept mod
   *CODE:(,,"Code")=(1234,99_OFFIS_DCMTK, "Code Meaning")
