 ...
 */
class DSRReferencedSamplePositionList : public DSRListOfItems<Uint32> {
public:
  /** default constructor
   */
   ...
   */
  DSRReferencedSamplePositionList& operator=(
   ...
   *DSRTypes::PF_xxx)
   *  @param  separator  character specifying the separator between the list
   *items
