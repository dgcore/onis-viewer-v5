 ...
 */
class DSRPNameTreeNode : public DSRDocumentTreeNode, public DSRStringValue {
public:
  /** constructor
   ...
   *  The five components of a DICOM Person Name (PN) are expected to be stored
   *in the XML elements "prefix", "first", "middle", "last" and "suffix" as
   *created by writeXML().
   ** @param  doc        document containing the XML file content
   *  @param  cursor     cursor pointing to the starting node
   *  @param  nameValue  reference to string object in which the value should be
   *stored
