 ...
 */
class DSRDateTreeNode : public DSRDocumentTreeNode, public DSRStringValue {
public:
  /** constructor
   ...
   *  The DICOM Date (DA) value is expected to be stored in ISO format as
   *created by writeXML().
   ** @param  doc          document containing the XML file content
   *  @param  cursor       cursor pointing to the corresponding node
   *  @param  dateValue    reference to string object in which the value should
   *be stored
  ...
  static OFString& getValueFromXMLNodeContent(
      const DSRXMLDocument& doc, DSRXMLCursor cursor, OFString& dateValue,
