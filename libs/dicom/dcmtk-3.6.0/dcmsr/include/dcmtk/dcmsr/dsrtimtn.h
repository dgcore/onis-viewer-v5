 ...
 */
class DSRTimeTreeNode : public DSRDocumentTreeNode, public DSRStringValue {
public:
  /** constructor
   ...
   *  The DICOM Time (TM) value is expected to be stored in ISO format as
   *created by writeXML().
   ** @param  doc          document containing the XML file content
   *  @param  cursor       cursor pointing to the corresponding node
   *  @param  timeValue    reference to string object in which the value should
   *be stored
   *  @param  clearString  flag specifying whether to clear the 'dateTimeValue'
   *or not
   ** @return reference to string object (might be empty)
   */
  static OFString& getValueFromXMLNodeContent(
      const DSRXMLDocument& doc, DSRXMLCursor cursor, OFString& timeValue,
