 ...
 */
class DSRTextTreeNode : public DSRDocumentTreeNode, public DSRStringValue {
public:
  /** constructor
  ...
  /** print content item.
   *  A typical output looks like this: contains TEXT:(,,"Text Code")="This is a
   *Text." If the 'flag' PF_shortenLongItemValues is set the text is limited to
