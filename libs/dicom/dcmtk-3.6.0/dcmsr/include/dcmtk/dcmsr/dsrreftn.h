 ...
 */
class DSRByReferenceTreeNode : public DSRDocumentTreeNode {
  // allow access to private member variables
  friend class DSRDocumentTree;

public:
  /** constructor
   ** @param  relationshipType  type of relationship to the parent/source tree
   *node. Should not be RT_invalid or RT_isRoot.
   */
   ...
   ** @return always returns EC_IllegalCall, since this content item has no
   *concept name
   */
   ...
   ** @return always returns EC_IllegalCall, since this content item has no
   *observation date and time (part of Document Relationship Macro)
   */
   ...
   ** @return always returns EC_IllegalCall, since this content item has no
   *template identification (part of Document Relationship Macro)
   */
