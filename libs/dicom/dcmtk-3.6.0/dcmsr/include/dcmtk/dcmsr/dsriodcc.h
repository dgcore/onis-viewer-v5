...
/** Class for checking the content relationship constraints of an SR IOD
 * (abstract)
 */
class DSRIODConstraintChecker : public DSRTypes {
public:
  /** default constructor
   */
   ...
   *(abstract)
   ** @return OFTrue if by-reference relationships are allowed, OFFalse
   *otherwise
   */
