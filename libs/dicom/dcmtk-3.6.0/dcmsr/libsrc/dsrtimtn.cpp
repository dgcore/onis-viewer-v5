...
DSRTimeTreeNode::DSRTimeTreeNode(const E_RelationshipType relationshipType)
    : DSRDocumentTreeNode(relationshipType, VT_Time), DSRStringValue() {}
...
OFString& DSRTimeTreeNode::getValueFromXMLNodeContent(
...
OFCondition DSRTimeTreeNode::renderHTMLContentItem(
