...
DSRDateTreeNode::DSRDateTreeNode(const E_RelationshipType relationshipType)
    : DSRDocumentTreeNode(relationshipType, VT_Date), DSRStringValue() {}
...
OFString& DSRDateTreeNode::getValueFromXMLNodeContent(
...
OFCondition DSRDateTreeNode::renderHTMLContentItem(
