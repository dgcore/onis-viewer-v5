...
#define LOG4CPLUS_MACRO_BODY(logger, logEvent, logLevel)                  \
  do {                                                                    \
    if ((logger).isEnabledFor(log4cplus::logLevel##_LOG_LEVEL)) {         \
      ...
      (logger).forcedLog(log4cplus::logLevel##_LOG_LEVEL, _macros_string, \
...
#define LOG4CPLUS_MACRO_BODY(logger, logEvent, logLevel)                  \
  do {                                                                    \
    if ((logger).isEnabledFor(log4cplus::logLevel##_LOG_LEVEL)) {         \
      ...
      (logger).forcedLog(log4cplus::logLevel##_LOG_LEVEL, _macro_string,  \
                         __FILE__, __LINE__, LOG4CPLUS_MACRO_FUNCTION()); \
    }                                                                     \
  } while (0)
...
#define LOG4CPLUS_MACRO_STR_BODY(logger, logEvent, logLevel)                  \
  do {                                                                        \
    if ((logger).isEnabledFor(log4cplus::logLevel##_LOG_LEVEL)) {             \
      (logger).forcedLog(log4cplus::logLevel##_LOG_LEVEL, logEvent, __FILE__, \
