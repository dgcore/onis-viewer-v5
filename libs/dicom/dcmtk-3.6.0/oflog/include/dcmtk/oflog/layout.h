 ...
 * elements in reverse order. 225 [main] INFO org.apache.log4j.examples.SortAlgo
 * - Entered the sort method. 262 [main] DEBUG
 * org.apache.log4j.examples.SortAlgo.OUTER i=1 - Outer loop. 276 [main] DEBUG
 * org.apache.log4j.examples.SortAlgo.SWAP i=1 j=0 - Swapping intArray[0] = 1
 * and intArray[1] = 0 290 [main] DEBUG org.apache.log4j.examples.SortAlgo.OUTER
 * i=0 - Outer loop. 304 [main] INFO  org.apache.log4j.examples.SortAlgo.DUMP -
 * Dump of interger array: 317 [main] INFO
 * org.apache.log4j.examples.SortAlgo.DUMP - Element [0] = 0 331 [main] INFO
 * org.apache.log4j.examples.SortAlgo.DUMP - Element [1] = 1 343 [main] INFO
 * org.apache.log4j.examples.Sort - The next log statement should be an error
 * message. 346 [main] ERROR org.apache.log4j.examples.SortAlgo.DUMP - Tried to
 * dump an uninitialized array. 467 [main] INFO  org.apache.log4j.examples.Sort
 * - Exiting main method.
 * </pre>
 *
 ...
 * specific</b> <li>%%S -- Second as decimal(0-59)</li> <li>%%U -- Week of year,
 * Sunday being first day(0-53)</li> <li>%%w -- Weekday as a decimal(0-6, Sunday
 * being 0)</li> <li>%%W -- Week of year, Monday being first day(0-53)</li>
