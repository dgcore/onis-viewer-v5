...
public:
   ...
   */
  virtual SharedAppenderPtr createObject(
      const log4cplus::helpers::Properties& props,
      log4cplus::tstring& error) = 0;
};
...
public:
   ...
   */
  virtual OFauto_ptr<Layout> createObject(
      const log4cplus::helpers::Properties& props,
      log4cplus::tstring& error) = 0;
};
...
public:
   ...
   */
  virtual FilterPtr createObject(const log4cplus::helpers::Properties& props,
                                 log4cplus::tstring& error) = 0;
};
