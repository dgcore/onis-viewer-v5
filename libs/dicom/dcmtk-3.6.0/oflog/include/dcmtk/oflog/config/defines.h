...
/* Defined if the compiler understands __declspec(export) or
 * __attribute__((export)) construct. */
#define LOG4CPLUS_DECLSPEC_EXPORT
/* Defined if the compiler understands __declspec(import) or
 * __attribute__((import)) construct. */
