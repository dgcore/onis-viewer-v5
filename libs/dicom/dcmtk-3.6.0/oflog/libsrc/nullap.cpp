...
log4cplus::NullAppender::NullAppender(
    const log4cplus::helpers::Properties& properties, tstring&)
    : Appender(properties) {}
...
void log4cplus::NullAppender::close() {}
...
void log4cplus::NullAppender::append(const spi::InternalLoggingEvent&) {}
