...
log4cplus::SysLogAppender::SysLogAppender(const tstring& id) : ident(id) {
...
void log4cplus::SysLogAppender::close() {
...
int log4cplus::SysLogAppender::getSysLogLevel(const LogLevel& ll) const {
...
void log4cplus::SysLogAppender::append(const spi::InternalLoggingEvent& event) {
