...
static const char* verify_string1(const char* s) {
  if (s == NULL) {
#ifdef DEBUG
    fprintf(stderr,
...
OFString::OFString() : theCString(NULL), theSize(0), theCapacity(0) {
  reserve(1);
}
...
OFString& OFString::append(const OFString& str, size_t pos, size_t n) {
  ...
  OFBitmanipTemplate<char>::copyMem(
      b.theCString, this->theCString + this->size(), b.size() + 1);
  this->theSize += b.size();

  return *this;
}

OFString& OFString::append(const char* s, size_t n) {
  OFString str(s, n);
...
OFString& OFString::append(size_t rep, char c) {
  OFString str(rep, c);
  return this->append(str);
}
...
OFString& OFString::assign(const OFString& str, size_t pos, size_t n) {
  ...
  if (n > 0) {
    ...
    OFBitmanipTemplate<char>::moveMem(str.theCString + pos, this->theCString,
                                      n);
    this->theCString[n] = '\0';
    this->theSize = n;
  } else {
...
OFString& OFString::assign(const char* s, size_t n) {
  OFString str(s, n);
...
OFString& OFString::assign(size_t rep, char c) {
  OFString str(rep, c);
  return this->assign(str);
}
...
OFString& OFString::insert(size_t pos1, const OFString& str, size_t pos2,
                           size_t n) {
...
OFString& OFString::insert(size_t pos, const char* s, size_t n) {
  OFString str(s, n);
  return this->insert(pos, str);
}

OFString& OFString::insert(size_t pos, const char* s) {
  OFString str(s);
  return this->insert(pos, str);
}

OFString& OFString::insert(size_t pos, size_t rep, char s) {
  OFString str(rep, s);
  return this->insert(pos, str);
}
...
** Erase
*/
OFString& OFString::erase(size_t pos, size_t n) {
...
OFString& OFString::replace(size_t pos1, size_t n1, const OFString& str,
...
OFString& OFString::replace(size_t pos, size_t n, const char* s, size_t n2) {
  OFString str(s, n2);
  return this->replace(pos, n, str);
}

OFString& OFString::replace(size_t pos, size_t n, const char* s) {
  OFString str(s);
  return this->replace(pos, n, str);
}

OFString& OFString::replace(size_t pos, size_t n, size_t rep, char s) {
  OFString str(rep, s);
  return this->replace(pos, n, str);
}
...
void OFString::resize(size_t n, char c) {
...
void OFString::reserve(size_t res_arg) {
  ...
  if (this->theCapacity < res_arg) {
    ...
    if (newstr) {
      ...
      OFBitmanipTemplate<char>::zeroMem(newstr + usedSpace,
                                        res_arg - usedSpace);
...
size_t OFString::copy(char* s, size_t n, size_t pos) const {
...
OFString OFString::substr(size_t pos, size_t n) const {
  OFString sub;
...
int OFString::compare(size_t pos1, size_t n1, const OFString& str) const {
  return OFString(*this, pos1, n1).compare(str);
}

int OFString::compare(size_t pos1, size_t n1, const OFString& str, size_t pos2,
                      size_t n2) const {
...
int OFString::compare(size_t pos1, size_t n1, const char* s, size_t n2) const {
...
size_t OFString::find(const OFString& pattern, size_t pos) const {
...
size_t OFString::find(const char* pattern, size_t pos, size_t n) const {
  OFString str(pattern, n);
  return this->find(str, pos);
}

size_t OFString::find(const char* pattern, size_t pos) const {
  OFString str(pattern);
  return this->find(str, pos);
}

size_t OFString::find(char pattern, size_t pos) const {
  size_t i = pos;
  const size_t this_size = this->size();
...
size_t OFString::rfind(const OFString& pattern, size_t pos) const {
  /* determine string length only once */
  const size_t this_size = this->size();
  const size_t pattern_size = pattern.size();
  ...
  int above =
      ((this_size - pattern_size) < pos) ? (this_size - pattern_size) : pos;
...
size_t OFString::rfind(const char* pattern, size_t pos, size_t n) const {
  OFString str(pattern, n);
  return this->rfind(str, pos);
}

size_t OFString::rfind(const char* pattern, size_t pos) const {
  OFString str(pattern);
  return this->rfind(str, pos);
}

size_t OFString::rfind(char pattern, size_t pos) const {
...
size_t OFString::find_first_of(const OFString& str, size_t pos) const {
  /* determine string length only once */
  const size_t this_size = this->size();
  const size_t str_size = str.size();
...
size_t OFString::find_first_of(const char* s, size_t pos, size_t n) const {
  OFString str(s, n);
  return this->find_first_of(str, pos);
}

size_t OFString::find_first_of(const char* s, size_t pos) const {
  OFString str(s);
  return this->find_first_of(str, pos);
}

size_t OFString::find_first_of(char s, size_t pos) const {
  OFString str(1, s);
  return this->find_first_of(str, pos);
}
...
size_t OFString::find_last_of(const OFString& str, size_t pos) const {
  /* determine string length only once */
  const size_t this_size = this->size();
  const size_t str_size = str.size();
...
size_t OFString::find_last_of(const char* s, size_t pos, size_t n) const {
  OFString str(s, n);
  return this->find_last_of(str, pos);
}

size_t OFString::find_last_of(const char* s, size_t pos) const {
  OFString str(s);
  return this->find_last_of(str, pos);
}

size_t OFString::find_last_of(char s, size_t pos) const {
  OFString str(1, s);
  return this->find_last_of(str, pos);
}
...
size_t OFString::find_first_not_of(const OFString& str, size_t pos) const {
  /* determine string length only once */
  const size_t this_size = this->size();
  const size_t str_size = str.size();
  if ((this_size == 0) || (str_size == 0) || (pos == OFString_npos)) {
...
size_t OFString::find_first_not_of(const char* s, size_t pos, size_t n) const {
  OFString str(s, n);
  return this->find_first_not_of(str, pos);
}

size_t OFString::find_first_not_of(const char* s, size_t pos) const {
  OFString str(s);
  return this->find_first_not_of(str, pos);
}

size_t OFString::find_first_not_of(char s, size_t pos) const {
  OFString str(1, s);
  return this->find_first_not_of(str, pos);
}
...
size_t OFString::find_last_not_of(const OFString& str, size_t pos) const {
  /* determine string length only once */
  const size_t this_size = this->size();
  const size_t str_size = str.size();
  if ((this_size == 0) || (str_size == 0)) {
...
size_t OFString::find_last_not_of(const char* s, size_t pos, size_t n) const {
  OFString str(s, n);
  return this->find_last_not_of(str, pos);
}

size_t OFString::find_last_not_of(const char* s, size_t pos) const {
  OFString str(s);
  return this->find_last_not_of(str, pos);
}

size_t OFString::find_last_not_of(char s, size_t pos) const {
  OFString str(1, s);
  return this->find_last_not_of(str, pos);
}
