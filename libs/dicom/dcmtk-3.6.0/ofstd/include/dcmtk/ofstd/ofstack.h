 ...
 *
 *  Purpose:
 *      Defines a template stack class with interfaces similar to the C++
 * Standard
 *
...
public:
  /// default constructor
  OFStackBase() : head(NULL), stackSize(0) {}
