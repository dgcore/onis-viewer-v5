...
public:
  ...
  /** constructs a temporary string from the input s and assigns it to the
   * current string.
   *  @param s pointer to a zero-terminated C string. Must not be NULL.
   *  @return reference to this object
   */
  ...
  /** constructs a temporary string from the input s and appends it to the
   * current string.
   *  @param s pointer to a zero-terminated C string. Must not be NULL.
   *  @return reference to this object
   */
   ...
   *  @return reference to this object
   */
  OFString& append(const OFString& str, size_t pos = 0,
                   size_t n = OFString_npos);

  /** constructs a temporary string from the input and appends it to the current
   * string.
   *  @param s pointer to an array of char of length n. Must not be NULL.
   *  @param n number of characters in array
   *  @return reference to this object
  ...
  /** constructs a temporary string from the input and assigns it to the current
   * string.
   *  @param s pointer to an array of char of length n. Must not be NULL.
   *  @param n number of characters in array
   *  @return reference to this object
   ...
   *  @return reference to this object
   */
  OFString& insert(size_t pos1, const OFString& str, size_t pos2 = 0,
                   size_t n = OFString_npos);
  ...
  /** constructs a temporary string from the input and replaces the range [pos,
   * n] in the current string with the constructed string.
   ...
   *  @return comparison result
   */
  int compare(size_t pos1, size_t n1, const OFString& str, size_t pos2,
              size_t n2) const;
   ...
   *  occurrence of the pattern in the current string object, starting from
   * position pos in the current string. If find can determine such an
   * occurrence, it returns the starting index of pattern in the current string.
   *  Otherwise, it returns string::npos.
   ...
   *  location can be determined, it is returned. Otherwise, the function
   *  returns string::npos.
   *  @param s set of characters to find, pointer to an array of char of length
   * n. Must not be NULL.
   *  @param pos position to start searching from
   *  @param n number of characters in array
   *  @return index of pattern in string
   ...
   *  location can be determined, it is returned. Otherwise, the function
   *  returns string::npos.
   *  @param s set of characters to find, pointer to a zero-terminated C string.
   * Must not be NULL.
   *  @param pos position to start searching from
   *  @return index of pattern in string
   */
   ...
   *  @return index of character as described above
   */
  size_t find_last_not_of(const OFString& str,
                          size_t pos = OFString_npos) const;
  ...
  /** returns a constant iterator that points after the last element of the
   * string
...
/** appends the string rhs to lhs.
 *  @param lhs left-hand side string, pointer to a zero-terminated C string.
 * Must not be NULL.
 *  @param rhs right-hand side string
 *  @return concatenated string, by value
 */
...
/** appends the string rhs to lhs.
 *  @param lhs left-hand side string
 *  @param rhs right-hand side string, pointer to a zero-terminated C string.
 * Must not be NULL.
 *  @return concatenated string, by value
 */
