...
DJEncoderBaseline::DJEncoderBaseline() : DJCodecEncoder() {}
...
void DJEncoderBaseline::createDerivationDescription(
  ...
  derivationDescription =
      "Lossy compression with JPEG baseline, IJG quality factor ";
...
DJEncoder* DJEncoderBaseline::createEncoderInstance(
  ...
  const DJ_RPLossy* rp =
      toRepParam ? (const DJ_RPLossy*)toRepParam : &defaultRP;
  DJCompressIJG8Bit* result =
      new DJCompressIJG8Bit(*cp, EJM_baseline, rp->getQuality());
