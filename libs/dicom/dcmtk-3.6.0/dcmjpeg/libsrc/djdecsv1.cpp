 ...
 *
 *  Purpose: Codec class for decoding JPEG Lossless Selection Value 1
 * (8/12/16-bit)
 *
...
DJDecoderP14SV1::DJDecoderP14SV1() : DJCodecDecoder() {}
...
DJDecoder* DJDecoderP14SV1::createDecoderInstance(
  ...
  if (bitsPerSample > 12)
    return new DJDecompressIJG16Bit(*cp, isYBR);
  else if (bitsPerSample > 8)
    return new DJDecompressIJG12Bit(*cp, isYBR);
  else
