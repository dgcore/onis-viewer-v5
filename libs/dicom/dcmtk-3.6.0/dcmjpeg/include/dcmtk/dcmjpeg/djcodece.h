...
protected:
   ...
   */
  static OFCondition togglePlanarConfiguration8(Uint8* pixelData,
   ...
   *  @return EC_Normal, if conversion was successful; error else
   */
  static OFCondition togglePlanarConfiguration16(Uint16* pixelData,
                                                 const unsigned long numValues,
                                                 const Uint16 samplesPerPixel,
                                                 const Uint16 oldPlanarConfig);
...
private:
   ...
   *  @param pixSeq - [out] compressed pixel sequence (pointer to new
   * DcmPixelSequence object allocated on heap) returned in this parameter upon
   * success
   *  @param cp - [in] codec parameters for this codec
   *  @param objStack - [in/out] stack pointing to the location of the pixel
   * data element in the current dataset.
   *  @return EC_Normal if successful, an error code otherwise.
   */
   ...
   *  @return EC_Normal if successful, an error code otherwise
   */
  virtual OFCondition updateLossyCompressionRatio(DcmItem* dataset,
                                                  double ratio) const;
   ...
   *  @return EC_Normal if successful, an error code otherwise
   */
  static OFCondition correctVOIWindows(DcmItem* dataset, double voiOffset,
                                       double voiFactor);

  OFCondition updatePlanarConfiguration(DcmItem* item,
