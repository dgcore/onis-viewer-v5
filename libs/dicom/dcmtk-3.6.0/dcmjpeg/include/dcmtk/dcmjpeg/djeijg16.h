...
public:
   ...
   */
  DJCompressIJG16Bit(const DJCodecParameter& cp, EJ_Mode mode, int prediction,
                     int ptrans);
   ...
   *  @param length length of compressed frame (in bytes) returned in this
   * parameter upon success; length guaranteed to be always even.
