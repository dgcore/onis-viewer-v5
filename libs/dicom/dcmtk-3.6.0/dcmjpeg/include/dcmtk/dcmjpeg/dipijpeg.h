 ...
 */
class DiJPEGPlugin : public DiPluginFormat {
public:
  /** constructor
   */
  DiJPEGPlugin();
   ...
   */
  virtual int write(DiImage* image, FILE* stream,
   ...
   *  Only used for color images. ESS_444 means no sub-sampling, ESS_422
   * horizontal subsampling of chroma components and ESS_422 horizontal and
   * vertical subsampling of chroma components.
