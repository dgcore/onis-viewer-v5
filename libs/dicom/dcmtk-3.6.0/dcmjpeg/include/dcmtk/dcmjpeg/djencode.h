 ...
 *
 *  Purpose: singleton class that registers encoders for all supported JPEG
 * processes.
 *
...
public:
   ...
   *  @param pRealLossless Enables true lossless compression (replaces old
   * "pseudo" lossless encoders)
   */
  static void registerCodecs(
      ...
      OFBool pAcrNemaCompatibility = OFFalse, OFBool pRealLossless = OFTrue);
