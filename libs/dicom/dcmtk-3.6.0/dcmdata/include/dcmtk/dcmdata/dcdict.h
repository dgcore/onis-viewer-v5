...
public:
  ...
  int numberOfRepeatingTagEntries() const {
    return OFstatic_cast(int, repDict.size());
  }
...
public:
  /** constructor.
   *  @param loadBuiltin if true, the dictionary constructor calls
   * loadBuiltinDictionary().
   *  @param loadExternal if true, the dictionary constructor calls
