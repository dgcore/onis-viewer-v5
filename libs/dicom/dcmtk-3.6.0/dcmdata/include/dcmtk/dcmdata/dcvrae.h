...
/** a class representing the DICOM value representation 'Application Entity'
 * (AE)
 */
...
public:
  ...
  /** check whether given string value conforms to the VR "AE" (Application
   * Entity) and to the specified VM.
