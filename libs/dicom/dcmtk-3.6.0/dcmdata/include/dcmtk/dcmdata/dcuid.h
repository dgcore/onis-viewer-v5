 ...
 *  @param uid pointer to buffer of 65 or more characters in which the UID is
 * returned
 ...
 *  Average sizes are defined for all storage SOP classes, but may be very far
 * off.
 *  @param sopClassUID UID string
...
#define OFFIS_DTK_IMPLEMENTATION_VERSION_NAME \
  "OFFIS_DCMTK_" PACKAGE_VERSION_SUFFIX

/// implementation version name for this version of the toolkit, used for files
/// received in "bit preserving" mode
#define OFFIS_DTK_IMPLEMENTATION_VERSION_NAME2 \
  "OFFIS_DCMBP_" PACKAGE_VERSION_NUMBER
...
#define OFFIS_DCMTK_VERSION \
  OFFIS_DCMTK_VERSION_STRING OFFIS_DCMTK_VERSION_SUFFIX

/// Implementation class UID for this release of the toolkit
#define OFFIS_IMPLEMENTATION_CLASS_UID \
...
#define OFFIS_CODING_SCHEME_UID \
  OFFIS_CODING_SCHEME_UID_ROOT "." OFFIS_CODING_SCHEME_VERSION

/*
** Each site should define its own SITE_UID_ROOT
*/
#ifndef SITE_UID_ROOT
/// UID root to be used when generating UIDs. By default uses the DCMTK root,
/// but can be replaced at compile time.
...
#define UID_DeflatedExplicitVRLittleEndianTransferSyntax \
...
#define UID_JPEG2000Part2MulticomponentImageCompressionLosslessOnlyTransferSyntax \
  "1.2.840.10008.1.2.4.92"
/// JPEG 2000 Part 2 Multi-component Image Compression (Lossless or Lossy)
#define UID_JPEG2000Part2MulticomponentImageCompressionTransferSyntax \
...
#define UID_MPEG4BDcompatibleHighProfileLevel4_1TransferSyntax \
...
/** XML encoding (Supplement 114) is only a pseudo transfer syntax used to refer
 * to encapsulated HL7 CDA documents from a DICOMDIR when stored on a DICOM
 * storage medium. It is never used for network communication or encoding of
 * DICOM objects.
 */
...
#define UID_DigitalMammographyXRayImageStorageForPresentation \
  "1.2.840.10008.5.1.4.1.1.1.2"
#define UID_DigitalMammographyXRayImageStorageForProcessing \
  "1.2.840.10008.5.1.4.1.1.1.2.1"
#define UID_DigitalIntraOralXRayImageStorageForPresentation \
  "1.2.840.10008.5.1.4.1.1.1.3"
#define UID_DigitalIntraOralXRayImageStorageForProcessing \
...
#define UID_MultiframeSingleBitSecondaryCaptureImageStorage \
  "1.2.840.10008.5.1.4.1.1.7.1"
#define UID_MultiframeGrayscaleByteSecondaryCaptureImageStorage \
  "1.2.840.10008.5.1.4.1.1.7.2"
#define UID_MultiframeGrayscaleWordSecondaryCaptureImageStorage \
  "1.2.840.10008.5.1.4.1.1.7.3"
#define UID_MultiframeTrueColorSecondaryCaptureImageStorage \
...
#define UID_CardiacElectrophysiologyWaveformStorage \
...
#define UID_GrayscaleSoftcopyPresentationStateStorage \
  "1.2.840.10008.5.1.4.1.1.11.1"
#define UID_ColorSoftcopyPresentationStateStorage "1.2.840.10008.5.1.4.1.1.11.2"
#define UID_PseudoColorSoftcopyPresentationStateStorage \
  "1.2.840.10008.5.1.4.1.1.11.3"
#define UID_BlendingSoftcopyPresentationStateStorage \
  "1.2.840.10008.5.1.4.1.1.11.4"
#define UID_XAXRFGrayscaleSoftcopyPresentationStateStorage \
...
#define UID_RETIRED_XRayAngiographicBiPlaneImageStorage \
...
#define UID_VLSlideCoordinatesMicroscopicImageStorage \
...
#define UID_OphthalmicPhotography8BitImageStorage \
  "1.2.840.10008.5.1.4.1.1.77.1.5.1"
#define UID_OphthalmicPhotography16BitImageStorage \
...
#define UID_SubjectiveRefractionMeasurementsStorage \
...
#define UID_MacularGridThicknessAndVolumeReportStorage \
  "1.2.840.10008.5.1.4.1.1.79.1"
#define UID_OphthalmicVisualFieldStaticPerimetryMeasurementsStorage \
...
// DICOMDIR; was UID_BasicDirectoryStorageSOPClass in DCMTK versions prior
// to 3.5.3
#define UID_MediaStorageDirectoryStorage "1.2.840.10008.1.3.10"

/* Hanging Protocols Storage is a special case because hanging protocols use a
   different information model, i.e. there is no patient, study or series in a
   hanging protocol IOD. */
#define UID_HangingProtocolStorage "1.2.840.10008.5.1.4.38.1"

// Query/Retrieve
#define UID_FINDPatientRootQueryRetrieveInformationModel \
  "1.2.840.10008.5.1.4.1.2.1.1"
#define UID_MOVEPatientRootQueryRetrieveInformationModel \
  "1.2.840.10008.5.1.4.1.2.1.2"
#define UID_GETPatientRootQueryRetrieveInformationModel \
  "1.2.840.10008.5.1.4.1.2.1.3"
#define UID_FINDStudyRootQueryRetrieveInformationModel \
  "1.2.840.10008.5.1.4.1.2.2.1"
#define UID_MOVEStudyRootQueryRetrieveInformationModel \
  "1.2.840.10008.5.1.4.1.2.2.2"
#define UID_GETStudyRootQueryRetrieveInformationModel \
  "1.2.840.10008.5.1.4.1.2.2.3"
#define UID_RETIRED_FINDPatientStudyOnlyQueryRetrieveInformationModel \
  "1.2.840.10008.5.1.4.1.2.3.1"
#define UID_RETIRED_MOVEPatientStudyOnlyQueryRetrieveInformationModel \
  "1.2.840.10008.5.1.4.1.2.3.2"
#define UID_RETIRED_GETPatientStudyOnlyQueryRetrieveInformationModel \
  "1.2.840.10008.5.1.4.1.2.3.3"
#define UID_RETIRED_MOVECompositeInstanceRootRetrieve \
  "1.2.840.10008.5.1.4.1.2.4.2"
#define UID_RETIRED_GETCompositeInstanceRootRetrieve \
  "1.2.840.10008.5.1.4.1.2.4.3"
#define UID_RETIRED_GETCompositeInstanceRetrieveWithoutBulkData \
...
#define UID_GeneralPurposeScheduledProcedureStepSOPClass \
  "1.2.840.10008.5.1.4.32.2"
#define UID_GeneralPurposePerformedProcedureStepSOPClass \
  "1.2.840.10008.5.1.4.32.3"
#define UID_GeneralPurposeWorklistManagementMetaSOPClass \
  "1.2.840.10008.5.1.4.32"

// MPPS
#define UID_ModalityPerformedProcedureStepSOPClass "1.2.840.10008.3.1.2.3.3"
#define UID_ModalityPerformedProcedureStepRetrieveSOPClass \
  "1.2.840.10008.3.1.2.3.4"
#define UID_ModalityPerformedProcedureStepNotificationSOPClass \
  "1.2.840.10008.3.1.2.3.5"

// Unified Worklist and Procedure Step
#define UID_UnifiedWorklistAndProcedureStepServiceClass \
...
#define UID_UnifiedWorklistAndProcedureStepSOPInstance \
...
#define UID_RETIRED_StorageCommitmentPullModelSOPInstance \
...
#define UID_BreastImagingRelevantPatientInformationQuery \
...
#define UID_FINDGenericImplantTemplateInformationModel \
  "1.2.840.10008.5.1.4.43.2"
#define UID_MOVEGenericImplantTemplateInformationModel \
  "1.2.840.10008.5.1.4.43.3"
#define UID_GETGenericImplantTemplateInformationModel "1.2.840.10008.5.1.4.43.4"
#define UID_FINDImplantAssemblyTemplateInformationModel \
  "1.2.840.10008.5.1.4.44.2"
#define UID_MOVEImplantAssemblyTemplateInformationModel \
  "1.2.840.10008.5.1.4.44.3"
#define UID_GETImplantAssemblyTemplateInformationModel \
...
#define UID_RETIRED_ReferencedGrayscalePrintManagementMetaSOPClass \
...
#define UID_PrinterConfigurationRetrievalSOPInstance \
  "1.2.840.10008.5.1.1.17.376"
#define UID_BasicColorPrintManagementMetaSOPClass "1.2.840.10008.5.1.1.18"
#define UID_RETIRED_ReferencedColorPrintManagementMetaSOPClass \
...
#define UID_RETIRED_PullStoredPrintManagementMetaSOPClass \
  "1.2.840.10008.5.1.1.32"

// Detached Management
#define UID_RETIRED_DetachedPatientManagementSOPClass "1.2.840.10008.3.1.2.1.1"
#define UID_RETIRED_DetachedPatientManagementMetaSOPClass \
...
#define UID_RETIRED_DetachedResultsManagementMetaSOPClass \
  "1.2.840.10008.3.1.2.5.4"
#define UID_RETIRED_DetachedStudyManagementMetaSOPClass \
  "1.2.840.10008.3.1.2.5.5"
#define UID_RETIRED_DetachedInterpretationManagementSOPClass \
...
#define UID_LDAP_dicomAuthorizedNodeCertificateReference \
...
#define UID_UniversalCoordinatedTimeSynchronizationFrameOfReference \
...
#define UID_PrivateShutdownSOPClass \
 ...
 * versions of various DICOM supplements and are or will be changed before final
 * text. Since it is likely that trial implementations exist, we leave the UIDs
 * in the dictionary.
 */
...
** Updated Version Number and Implementation Version Name to reflect the
**   current public release (3.3.1). Updated documentation to reflect changes
*in 3.3.1.
**
