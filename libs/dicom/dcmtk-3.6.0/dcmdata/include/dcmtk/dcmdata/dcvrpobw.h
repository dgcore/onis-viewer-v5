...
/** a class representing DICOM elements (such as uncompressed pixel data) that
 * can be interpreted either as OB or as OW, i.e. are polymorph.
 */
...
private:
   ...
   *  at the beginning to the write operation and needs to be changed back once
