...
public:
   ...
   * "2-n", "2-2n", "3", "3-n", "3-3n", "4", "9", "6", "16", "32")
   ...
   *  The output format of the value is a backslash separated sequence of group
   * and element value pairs, e.g. "(0008,0020)\(0008,0030)"
