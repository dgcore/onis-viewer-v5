...
public:
   ...
   *  Please note that only an element value consisting of zero or more spaces
   * is considered as being empty and, therefore, results in an empty vector
   * with status ".good()"; use isEmpty() before calling this method if you also
   * want to check for other non-significant characters (e.g. the backslash).
