...
/** a class representing the DICOM value representation 'Floating Point Single'
 * (FL)
 */
...
public:
   ...
   *  The output format of the value is a backslash separated sequence of
   * numbers. This function uses a variable number of digits for the floating
   * point values as created by the OFStandard::ftoa() function by default.
