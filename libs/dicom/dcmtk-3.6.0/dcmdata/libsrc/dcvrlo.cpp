...
DcmLongString::DcmLongString(const DcmTag& tag, const Uint32 len)
    : DcmCharString(tag, len) {
  setMaxLength(64);
  setNonSignificantChars(" \\");
}

DcmLongString::DcmLongString(const DcmLongString& old) : DcmCharString(old) {}
...
OFCondition DcmLongString::checkStringValue(const OFString& value,
                                            const OFString& vm) {
  return DcmByteString::checkStringValue(value, vm, "lo",
                                         12 /*, maxLen: 64 characters */);
}
