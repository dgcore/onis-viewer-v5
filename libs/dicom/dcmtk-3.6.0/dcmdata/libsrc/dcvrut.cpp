...
DcmUnlimitedText::DcmUnlimitedText(const DcmTag& tag, const Uint32 len)
...
OFCondition DcmUnlimitedText::checkStringValue(const OFString& value) {
  return DcmByteString::checkStringValue(
      value, "" /* vm */, "lt", 14 /*, maxLength: 4294967295 characters */);
}
