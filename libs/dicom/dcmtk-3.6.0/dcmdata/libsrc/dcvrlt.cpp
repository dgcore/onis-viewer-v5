...
DcmLongText::DcmLongText(const DcmTag& tag, const Uint32 len)
    : DcmCharString(tag, len) {
  setMaxLength(10240);
}

DcmLongText::DcmLongText(const DcmLongText& old) : DcmCharString(old) {}
...
OFCondition DcmLongText::checkStringValue(const OFString& value) {
  return DcmByteString::checkStringValue(value, "" /* vm */, "lt",
                                         14 /*, maxLength: 10240 characters */);
}
