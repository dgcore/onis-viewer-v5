...
const OFConditionConst ECC_TagNotFound(OFM_dcmdata, 2, OF_error,
                                       "Tag not found");
const OFConditionConst ECC_InvalidVR(OFM_dcmdata, 3, OF_error, "Invalid VR");
const OFConditionConst ECC_InvalidStream(OFM_dcmdata, 4, OF_error,
                                         "Invalid stream");
const OFConditionConst ECC_EndOfStream(OFM_dcmdata, 5, OF_error,
                                       "End of stream");
const OFConditionConst ECC_CorruptedData(OFM_dcmdata, 6, OF_error,
                                         "Corrupted data");
const OFConditionConst ECC_IllegalCall(
    OFM_dcmdata, 7, OF_error, "Illegal call, perhaps wrong parameters");
...
const OFConditionConst ECC_CannotChangeRepresentation(
    OFM_dcmdata, 14, OF_error, "Pixel representation cannot be changed");
...
const OFConditionConst ECC_ApplicationProfileViolated(
    OFM_dcmdata, 21, OF_error, "Storage media application profile violated");
// error code 22 is reserved for dcmodify error messages
const OFConditionConst ECC_InvalidOffset(OFM_dcmdata, 23, OF_error,
                                         "Invalid offset");
const OFConditionConst ECC_TooManyBytesRequested(OFM_dcmdata, 24, OF_error,
...
const OFConditionConst ECC_ElemLengthLargerThanItem(
    OFM_dcmdata, 27, OF_error,
    "Length of element larger than explicit length of surrounding item");
...
const OFConditionConst ECC_SeqOrItemContentOverflow(
    OFM_dcmdata, 29, OF_error,
    "Item or sequence content exceeds maximum of 32-bit length field");
const OFConditionConst ECC_ValueRepresentationViolated(
    OFM_dcmdata, 30, OF_error, "Value Representation violated");
const OFConditionConst ECC_ValueMultiplicityViolated(
    OFM_dcmdata, 31, OF_error, "Value Multiplicity violated");
const OFConditionConst ECC_MaximumLengthViolated(OFM_dcmdata, 32, OF_error,
                                                 "Maximum VR length violated");
const OFConditionConst ECC_ElemLengthExceeds16BitField(
    OFM_dcmdata, 33, OF_error,
    "Length of element value exceeds maximum of 16-bit length field");
...
const OFCondition EC_ValueRepresentationViolated(
    ECC_ValueRepresentationViolated);
...
const OFCondition EC_ElemLengthExceeds16BitField(
    ECC_ElemLengthExceeds16BitField);
