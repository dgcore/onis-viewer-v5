 ...
 * The following settings are not tested by configure but need to be set for
 * MinGW.
 */
#ifdef __MINGW32__
...
#define CANONICAL_HOST_TYPE "Hello Onis"
...
#define DCM_DICT_DEFAULT_PATH "c:\\"
...
/* Define if your system has a declaration for struct utimbuf in sys/types.h
   utime.h sys/utime.h */
#define HAVE_DECLARATION_STRUCT_UTIMBUF
...
/* Define if your system cannot pass command line arguments into main() (e.g.
 * Macintosh). */
...
#define PACKAGE_DATE "2011/08/02"
...
#define PACKAGE_VERSION_NUMBER "3.6.0"

/* Define to the version suffix of this package. */
#define PACKAGE_VERSION_SUFFIX "360"
