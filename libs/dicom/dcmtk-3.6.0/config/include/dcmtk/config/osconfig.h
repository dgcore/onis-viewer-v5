...
*/
#ifdef WIN32
#include "dcmtk/config/cfwindows.h"
#else
#ifdef ONIS_FOR_MAC
#include "dcmtk/config/cfosx.h"
#else
#ifdef _ONIS_FOR_LINUX_
#include "dcmtk/config/cflinux.h"
#endif
#endif
#endif /*                                                                  \
        ** Earlier, on windows sytems, cfwin32.h was included if DCMTK was \
        *built under windows. However, now osconfig.h is now automatically \
        *generated by CMake which makes this inclusion (and cfwin32.h in   \
        *general) obsolete.                                                \
        *                                                                  \
        */
#endif
