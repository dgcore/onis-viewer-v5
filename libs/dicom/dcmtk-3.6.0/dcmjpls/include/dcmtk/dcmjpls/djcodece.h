...
private:
   ...
   *  @return EC_Normal if successful, an error code otherwise.
   */
  OFCondition losslessRawEncode(const Uint16* pixelData, const Uint32 length,
                                DcmItem* dataset,
   ...
   *  @return EC_Normal if successful, an error code otherwise.
   */
  OFCondition losslessCookedEncode(const Uint16* pixelData, const Uint32 length,
                                   DcmItem* dataset,
                                   const DJLSRepresentationParameter* djrp,
                                   DcmPixelSequence*& pixSeq,
                                   const DJLSCodecParameter* djcp,
  ...
  OFCondition compressRawFrame(
      const Uint8* framePointer, Uint16 bitsAllocated, Uint16 columns,
   ...
   *  @return EC_Normal if successful, an error code otherwise
   */
  OFCondition compressCookedFrame(DcmPixelSequence* pixelSequence,
                                  DicomImage* dimage,
                                  const OFString& photometricInterpretation,
                                  DcmOffsetList& offsetList,
                                  unsigned long& compressedSize,
                                  const DJLSCodecParameter* djcp, Uint32 frame,
                                  Uint16 nearLosslessDeviation) const;
   ...
   */
  OFCondition convertToUninterleaved(Uint8* target, const Uint8* source,
   ...
   *  @return EC_Normal if succesful, an error code otherwise
   */
  OFCondition convertToSampleInterleaved(Uint8* target, const Uint8* source,
                                         Uint16 components, Uint32 width,
                                         Uint32 height,
