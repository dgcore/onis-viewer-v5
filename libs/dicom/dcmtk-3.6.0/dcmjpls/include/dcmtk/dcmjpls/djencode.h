 ...
 *
 *  Purpose: singleton class that registers encoders for all supported JPEG-LS
 * processes.
 *
...
public:
  ...
  static void registerCodecs(
      OFBool jpls_optionsEnabled = OFFalse, Uint16 jpls_t1 = 3,
      ...
      DJLSCodecParameter::interleaveMode jplsInterleaveMode =
          DJLSCodecParameter::interleaveDefault);
