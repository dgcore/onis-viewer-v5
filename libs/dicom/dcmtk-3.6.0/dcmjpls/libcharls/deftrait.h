...
// Default traits that support all JPEG LS parameters: custom limit, near,
// maxval (not power of 2)
...
// This is to allow the traits class to replace the default implementation here
// with optimized specific implementations. This is done for lossless
// coding/decoding: see losslesstraits.h
...
public:
  ...
  bool IsNear(Triplet<SAMPLE> lhs, Triplet<SAMPLE> rhs) const {
    return ABS(lhs.v1 - rhs.v1) <= NEAR && ABS(lhs.v2 - rhs.v2) <= NEAR &&
