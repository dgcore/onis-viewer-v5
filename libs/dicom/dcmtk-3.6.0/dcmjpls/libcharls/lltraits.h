...
//
// optimized trait classes for lossless compression of 8 bit color and 8/16 bit
// monochrome images. This class is assumes MAXVAL correspond to a whole number
// of bits, and no custom RESET value is set when encoding. The point of this is
// to have the most optimized code for the most common and most demanding
// scenario.
...
template <class SAMPLE, LONG bpp>
struct LosslessTraitsT<Triplet<SAMPLE>, bpp>
    : public LosslessTraitsImplT<SAMPLE, bpp> {
