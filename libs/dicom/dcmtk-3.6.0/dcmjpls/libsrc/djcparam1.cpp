...
DJLSCodecParameter::DJLSCodecParameter(
    ...
    Uint16 jpls_t2, Uint16 jpls_t3, Uint16 jpls_reset, Uint16 jpls_limit,
    OFBool preferCookedEncoding, Uint32 fragmentSize, OFBool createOffsetTable,
    JLS_UIDCreation uidCreation, OFBool convertToSC,
    JLS_PlanarConfiguration planarConfiguration, OFBool ignoreOffsetTble,
...
DJLSCodecParameter::DJLSCodecParameter(
    JLS_UIDCreation uidCreation, JLS_PlanarConfiguration planarConfiguration,
