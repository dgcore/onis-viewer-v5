...
/// signature verification failed because the corresponding MAC parameters item
/// could not be found or is incomplete
extern const OFCondition SI_EC_VerificationFailed_NoMAC;

/// signature verification failed because the corresponding signature item is
/// incomplete
...
/// signature verification failed because the signature is invalid (document
/// corrupted)
extern const OFCondition SI_EC_VerificationFailed_Corrupted;

/// signature verification failed because the certificate was issued by an
/// untrusted (unknown) CA
