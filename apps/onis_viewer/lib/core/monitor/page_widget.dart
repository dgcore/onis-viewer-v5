...
abstract class OsPageWidget extends StatefulWidget {
  ...
  @override
  OsPageWidgetState createState() => createPageState();

  /// Create the specific page state
  OsPageWidgetState createPageState();
}

abstract class OsPageWidgetState<T extends OsPageWidget> extends State<T>
  ...
  // Getters
  OsPage? get page => widget._page?.target;
  ...
  Future<void> _disposePage() async {
    try {
      ...
      OsPage? page = widget._page?.target;
      OsPageType? pageType = page?.getType();
      if (pageType != null) {
  ...
  Widget _buildPageHeader() {
    ...
    OsPage? page = widget._page?.target;
    OsPageType? pageType = page?.getType();
    if (pageType == null) return Container();
