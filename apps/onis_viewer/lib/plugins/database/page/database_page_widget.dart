...
class DatabasePageWidget extends OsPageWidget {
  DatabasePageWidget({
    super.key,
    required super.page,
  });
  ...
  @override
  OsPageWidgetState<DatabasePageWidget> createPageState() =>
      _DatabasePageWidgetState();
}

class _DatabasePageWidgetState extends OsPageWidgetState<DatabasePageWidget> {
